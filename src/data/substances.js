...
export const S = [
  ...
  {id:"nicotine",n:"Nicotine",cat:"stimulant",aka:["Cigarettes","Vape","Tobacco","Snus","Juul","Zyn"],src:"natural",
    ...
    addictNote:"Highest transition rate of any substance. 50% of dependent cases emerge within ~27 years of first use. The 10-year figure previously shown (~16%) was derived from their survival curve.",
    ...
    _src:{
      ...
      addictPct:     {ref:["lopez2011","wagner2002"], conf:"derived", note:"Lopez-Quintero 2011: lifetime = 67.5%. The ~15.6% 10-year figure is read from survival curve (Figure 1), not a directly reported number in the paper's text."},
  ...
  {id:"cannabis",n:"Cannabis",cat:"cannabinoid",aka:["Marijuana","Weed","THC","Pot","Edibles"],src:"natural",
    ...
    _src:{
      ...
      addictPct:     {ref:["lopez2011","wagner2002"], conf:"derived", note:"Lopez-Quintero 2011: lifetime = 8.9%. 5.9% 10-year figure derived from survival curve."},
