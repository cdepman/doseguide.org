...
export const CITE = {
  ...
  maryland_rad:   "Maryland Rapid Analysis of Drugs (RAD). MDH + NIST. Statewide drug checking 2021-2024. Published in Drug Alcohol Depend 2026.",
  italy_gcms:     "Ferretti et al. Drug checking in recreational settings (Italy). Frontiers in Psychiatry, 2021. GC/MS confirmed.",
...
export const S = [
  ...
  {id:"lsd",n:"LSD",cat:"psychedelic",aka:["Acid","Lucy","Tabs","Blotter"],src:"semi-synthetic",
    ...
    addict:1,addictLabel:"Not addictive",addictPct:0.5,addictLife:1,
    addictSource:"Estimated — psychedelics not individually reported in epidemiological studies",
    addictNote:"Rapid tolerance makes daily use impossible — you literally can't trip two days in a row. No physical dependence. Among the lowest addiction potential of any psychoactive substance.",
    ...
    _src:{
      ...
      addictPct:     {ref:null, conf:"estimated", note:"No epidemiological study reports LSD-specific dependence rates. Anthony 1994 grouped hallucinogens. 0.5% is a clinical consensus estimate based on rapid tolerance and absence of physical dependence."},
      addictLife:    {ref:null, conf:"estimated", note:"Same basis as addictPct."},
      margin:        {ref:"gable2006", conf:"derived", note:"Gable 2006 reports safety ratio >1000:1. No documented lethal dose in humans. marginBest/marginWorst set to null (no physical ceiling)."},
  ...
  {id:"mushrooms",n:"Psilocybin Mushrooms",sn:"Mushrooms",cat:"psychedelic",aka:["Shrooms","Magic Mushrooms","Caps"],src:"natural",
    ...
    addict:1,addictLabel:"Not addictive",addictPct:0.5,addictLife:1,
    addictSource:"Estimated — same rapid tolerance mechanism as LSD; no epidemiological data",
    addictNote:"Same rapid tolerance mechanism as LSD. The experience itself discourages frequent use for most people.",
    ...
    _src:{
      ...
      addictPct:     {ref:null, conf:"estimated", note:"Same basis as LSD. No epidemiological data for psilocybin-specific dependence."},
  ...
  {id:"dmt",n:"DMT",cat:"psychedelic",aka:["Dimitri","Spirit Molecule","Ayahuasca"],src:"natural",
    ...
    addict:1,addictLabel:"Not addictive",addictPct:0.5,addictLife:1,
    addictSource:"Estimated — no epidemiological data; clinical consensus based on self-limiting pharmacology",
    addictNote:"Intensity and brevity naturally limit use frequency.",
    ...
    _src:{
      harm:          {ref:null, conf:"estimated", note:"DMT not in Nutt 2010. Estimated at 6 based on pharmacological similarity to other classical psychedelics (LSD=7, mushrooms=5) and lack of documented harm."},
  ...
  {id:"mescaline",n:"Mescaline",cat:"psychedelic",aka:["Peyote","San Pedro"],src:"natural",
    ...
    addict:1,addictLabel:"Not addictive",addictPct:0.5,addictLife:1,
    addictSource:"Estimated — no epidemiological data; same class as other psychedelics",
    addictNote:"Long duration (8-12hr) and severe nausea further discourage frequent use.",
    ...
    _src:{
      ...
      addictPct:     {ref:null, conf:"estimated", note:"No epidemiological data. Same class estimate as LSD/psilocybin."},
  ...
  {id:"2cx",n:"2C-x (2C-B, 2C-E, 2C-I)",sn:"2C-x",cat:"psychedelic",aka:["Nexus","Bees","Tusi","Pink cocaine"],src:"synthetic",
    ...
    addict:1,addictLabel:"Not addictive",addictPct:0.5,addictLife:1,
    addictSource:"Estimated — no epidemiological data; phenethylamine psychedelic with rapid tolerance",
    addictNote:"Similar tolerance and self-limiting profile to other psychedelics.",
    ...
    _src:{
      ...
      margin:        {ref:null, conf:"editorial", note:"marginWorst 2x and marginBest 4x are estimates based on dose-response reports from PsychonautWiki and Erowid experience reports. No peer-reviewed safety ratio data."},
  ...
  {id:"mdma",n:"MDMA",cat:"empathogen",aka:["Ecstasy","Molly","E","X","Mandy"],src:"synthetic",
    ...
    addictSource:"Estimated from Schlag 2020 review — no study reports an exact MDMA-specific rate; 3% is extrapolated from the rank-ordering in Schlag's meta-review",
    addictNote:"Low capture rate partly because serotonin depletion makes frequent use self-punishing — you feel worse, not better, if you use too often.",
    ...
    _src:{
      ...
      margin:        {ref:"maps", conf:"derived", note:"MAPS trials used 120+60mg safely. marginWorst 1.5x reflects hyperthermia risk in adverse conditions at ~200mg. marginBest 4x from clinical toxicology thresholds."},
  ...
  {id:"cocaine",n:"Cocaine",cat:"stimulant",aka:["Coke","Snow","Blow","Crack"],src:"natural",
    ...
    marginExplain:"Most people tolerate a few lines (100-300mg total) without incident. The honest risk: about 1 in 50,000 users will have a cardiac event that's not clearly dose-related. The risk rises steeply with dose, re-dosing over hours, combining with alcohol (creates cocaethylene), and any pre-existing heart condition — even undiagnosed ones.",
    supplyRisk:5,pctAsExpected:81,supplyLabel:"~81% contains cocaine, but often with adulterants",
    supplyExplain:"Most contains cocaine but also levamisole (~70% of US supply). Fentanyl contamination >10% in NE states. Fentanyl strips can detect contamination.",
    addict:4,addictLabel:"Highly addictive",addictPct:14.8,addictLife:20.9,
    addictSource:"Lopez-Quintero 2011 (NESARC): cumulative probability of dependence",
    addictNote:"Hooks fast: most of the lifetime risk materializes within the first decade. Crack cocaine likely has a higher rate than powder.",
    ...
    _src:{
      ...
      margin:        {ref:null, conf:"editorial", note:"marginBest 5x and marginWorst 1x are clinical estimates. The cardiac event risk at any dose is documented but not expressible as a simple ratio. Based on clinical toxicology literature, not a single source."},
      pctAsExpected: {ref:"italy_gcms", conf:"measured", note:"Italy GC/MS study: cocaine 92% concordance. 81% estimate reflects US market with levamisole adulteration (DEA/NFLIS data)."},
      dose:          {ref:"psychonautwiki", conf:"measured", note:"PsychonautWiki dosage classification."},
    }},
  ...
  {id:"amphetamines",n:"Amphetamine",sn:"Amfeta",cat:"stimulant",aka:["Speed","Adderall","Dexedrine","Vyvanse"],src:"synthetic",
    ...
    addictSource:"Anthony 1994 (NCS): stimulants category. 11.2% lifetime from Wagner & Anthony 2002",
    ...
    _src:{
      ...
      margin:        {ref:null, conf:"editorial", note:"marginBest 5x and marginWorst 3x from clinical toxicology. Therapeutic index depends on formulation and individual cardiovascular health."},
  ...
  {id:"methamphetamine",n:"Methamphetamine",sn:"Meth",cat:"stimulant",aka:["Meth","Crystal","Ice","Tina","Glass"],src:"synthetic",
    ...
    addict:5,addictLabel:"Extremely addictive",addictPct:15,addictLife:20,
    addictSource:"Estimated from SAMHSA treatment admission data + clinical literature. No large-scale survival analysis like Lopez-Quintero exists for meth specifically.",
    addictNote:"Higher than regular amphetamine due to extreme dopamine release and long duration. Binge patterns develop quickly.",
    ...
    _src:{
      ...
      margin:        {ref:null, conf:"editorial", note:"marginBest 4x and marginWorst 2x from clinical toxicology reports. Binge pattern is the primary risk factor rather than single-dose toxicity."},
  ...
  {id:"nicotine",n:"Nicotine",cat:"stimulant",aka:["Cigarettes","Vape","Tobacco","Snus","Juul","Zyn"],src:"natural",
    ...
    addict:5,addictLabel:"EXTREMELY addictive",addictPct:15.6,addictLife:67.5,
    addictSource:"Lopez-Quintero 2011 (NESARC): lifetime cumulative probability = 67.5%. The 15.6% 10-year figure is derived from their survival curve, not a directly reported number.",
    addictNote:"The gap between 10yr (~16%) and lifetime (68%) tells the story: nicotine hooks you slowly but relentlessly. Hardest substance to quit permanently.",
    ...
    _src:{
      ...
      margin:        {ref:null, conf:"editorial", note:"marginBest 20x (smoking) and marginWorst 3x (concentrated liquid) are clinical estimates. Nausea prevents overdose from smoking. Liquid nicotine toxicity well-documented in poison control data."},
  ...
  {id:"cannabis",n:"Cannabis",cat:"cannabinoid",aka:["Marijuana","Weed","THC","Pot","Edibles"],src:"natural",
    ...
    addict:2,addictLabel:"Low addiction potential",addictPct:5.9,addictLife:8.9,
    addictSource:"Lopez-Quintero 2011 (NESARC): lifetime cumulative probability = 8.9%",
  ...
  {id:"ketamine",n:"Ketamine",cat:"dissociative",aka:["K","Special K","Ket","Vitamin K"],src:"synthetic",
    ...
    addict:3,addictLabel:"Moderately addictive",addictPct:6,addictLife:9,
    addictSource:"Estimated from UK clinical case series (Winstock & Mitcheson 2012, Morgan & Curran 2012). No large-scale survival analysis exists.",
    ...
    _src:{
      ...
      margin:        {ref:null, conf:"derived", note:"Ketamine's anesthetic dose is 5-10x recreational dose (well-established in anesthesia literature). marginBest 8x, marginWorst 2x based on clinical dosing vs. aspiration risk."},
  ...
  {id:"pcp",n:"PCP",cat:"dissociative",aka:["Angel Dust","Wet","Sherm","Dust"],src:"synthetic",
    ...
    addict:3,addictLabel:"Moderately addictive",addictPct:5,addictLife:7,
    addictSource:"Estimated from NIDA epidemiological reports. No survival analysis data exists for PCP specifically.",
    addictNote:"Psychological dependence can develop. Less studied than other substances because of smaller user population.",
    ...
    _src:{
      ...
      addictPct:     {ref:null, conf:"estimated", note:"Estimated from NIDA reports on PCP use patterns. No survival analysis."},
      margin:        {ref:null, conf:"editorial", note:"marginBest 3x and marginWorst 1x reflect unpredictable individual responses. Not based on a specific safety ratio study."},
  ...
  {id:"dxm",n:"DXM",cat:"dissociative",aka:["Dextromethorphan","Robo","Robotripping"],src:"synthetic",
    ...
    marginExplain:"DXM itself has a moderate margin. But many cough medicines contain acetaminophen (Tylenol), and a recreational DXM dose of that syrup delivers a liver-destroying dose of acetaminophen. Also: ~7% of people are poor metabolizers (CYP2D6) — for them, a normal dose hits 3-5x harder. Only DXM-only products avoid this risk.",
    ...
    addict:2,addictLabel:"Low addiction potential",addictPct:3,addictLife:5,
    addictSource:"Estimated — limited epidemiological data on DXM-specific dependence. Based on clinical case reports of compulsive use.",
    ...
    _src:{
      ...
      margin:        {ref:null, conf:"editorial", note:"marginBest 5x (pure DXM) from pharmacological data. marginWorst 1x reflects acetaminophen co-formulation danger and CYP2D6 poor metabolizer risk."},
  ...
  {id:"nitrous",n:"Nitrous Oxide",sn:"Nitrous",cat:"dissociative",aka:["Laughing Gas","N2O","Whippets","Nangs"],src:"synthetic",
    ...
    addict:2,addictLabel:"Low-moderate (binge pattern)",addictPct:2,addictLife:3,
    addictSource:"Estimated from clinical case reports of compulsive use. No epidemiological data.",
    ...
    _src:{
      harm:          {ref:null, conf:"estimated", note:"Nitrous not in Nutt 2010. Estimated at 8 based on low acute toxicity, delivery-method deaths, and B12 depletion risk with chronic use."},
      addictPct:     {ref:null, conf:"estimated", note:"2% estimated from clinical case reports. No epidemiological data."},
      margin:        {ref:null, conf:"editorial", note:"marginBest/marginWorst set to null. Danger is oxygen displacement, not dose-dependent toxicity."},
  ...
  {id:"poppers",n:"Poppers (Alkyl Nitrites)",sn:"Poppers",cat:"inhalant",aka:["Amyl Nitrite","Rush","Jungle Juice","Room Odorizer"],src:"synthetic",
    ...
    addict:1,addictLabel:"Not addictive",addictPct:0.5,addictLife:1,
    addictSource:"Estimated — clinical consensus based on pharmacology. No epidemiological data.",
    addictNote:"Essentially no addiction potential. Some habitual use in sexual contexts but not clinically meaningful dependence.",
    ...
    _src:{
      harm:          {ref:null, conf:"estimated", note:"Poppers (alkyl nitrites) not in Nutt 2010. Estimated at 6 based on low toxicity profile and self-limiting use."},
  ...
  {id:"alcohol",n:"Alcohol",cat:"depressant",aka:["Ethanol","Booze","Beer","Wine","Liquor"],src:"natural",
    ...
    addict:4,addictLabel:"Highly addictive",addictPct:11,addictLife:22.7,
    addictSource:"Lopez-Quintero 2011 (NESARC): lifetime cumulative probability = 22.7%",
    addictNote:"~1 in 9 people who drink will develop dependence within a decade. Because almost everyone drinks, alcohol creates more total addicts than any other substance.",
    ...
    _src:{
      ...
      margin:        {ref:"gable2006", conf:"derived", note:"Gable 2006: alcohol safety ratio ~10:1. marginBest 5x and marginWorst 2x account for aspiration risk at lower doses."},
  ...
  {id:"ghb",n:"GHB",cat:"depressant",aka:["G","Liquid Ecstasy","GBL","1,4-BD","Fantasy"],src:"synthetic",
    ...
    addict:4,addictLabel:"Highly addictive",addictPct:12,addictLife:15,
    addictSource:"Estimated from European clinical case series (van Noorden et al. 2009, Kamal et al. 2016). No large-scale survival analysis.",
    addictNote:"Physical dependence develops with daily use. GHB withdrawal is among the most dangerous — it can cause seizures, psychosis, and death. Abrupt cessation after daily use is life-threatening.",
    ...
    _src:{
      ...
      margin:        {ref:null, conf:"derived", note:"marginBest 2.5x, marginWorst 1.5x from clinical toxicology. Narrow therapeutic window is well-documented in anesthesia and toxicology literature."},
  ...
  {id:"benzodiazepine",n:"Benzodiazepines",sn:"Benzos",cat:"benzodiazepine",aka:["Benzos","Xanax","Valium","Klonopin","Ativan"],src:"synthetic",
    ...
    marginExplain:"Benzos alone have a genuinely large safety margin — some clinical reports describe survival after 30x+ normal doses (e.g. flurazepam). BUT: add any opioid and the margin drops to ~1x. Benzos + opioids is the #1 poly-drug death combination in America.",
    ...
    addict:4,addictLabel:"Highly addictive",addictPct:14,addictLife:18,
    addictSource:"Estimated from Nutt 2007 review + clinical literature on benzodiazepine dependence. No large-scale survival analysis comparable to Lopez-Quintero exists for benzos.",
    addictNote:"Physical dependence can develop in 2-4 weeks of daily use. Prescribed users often don't realize they're dependent until they try to stop. Withdrawal can cause seizures and death.",
    ...
    _src:{
      ...
      addictPct:     {ref:null, conf:"estimated", note:"14% estimated from clinical literature. Nutt 2007 development scale rated benzos high on dependence. No survival analysis data."},
      margin:        {ref:null, conf:"derived", note:"marginBest 30x documented in clinical toxicology (massive benzo overdoses survived with supportive care). marginWorst 1x reflects lethal synergy with opioids."},
  ...
  {id:"opioids",n:"Opioids (Heroin)",sn:"Opioids",cat:"opioid",aka:["Heroin","Morphine","H","Smack","Dope","Codeine"],src:"both",
    ...
    addict:5,addictLabel:"EXTREMELY addictive",addictPct:18,addictLife:23.1,
    addictSource:"Anthony 1994 (NCS): ~23% of heroin users develop dependence. 18% 10-year estimate consistent with survival analysis.",
    ...
    _src:{
      ...
      margin:        {ref:"gable2006", conf:"derived", note:"Gable 2006: heroin safety ratio ~6:1. marginBest 3x and marginWorst 1x reflect street supply variability."},
      pctAsExpected: {ref:"maryland_rad", conf:"measured", note:"Maryland RAD 2021-2024: 1.9% heroin concordance. Changed from 12% to 2% to match cited source. European markets significantly different (Italy: 88%)."},
  ...
  {id:"fentanyl",n:"Fentanyl",cat:"opioid",aka:["Fent","Blues","Pressed pills","China White"],src:"synthetic",
    ...
    addict:5,addictLabel:"EXTREMELY addictive",addictPct:20,addictLife:25,
    addictSource:"Estimated — no survival analysis for fentanyl specifically. Rate extrapolated from heroin (same receptor, faster onset = stronger reinforcement).",
    ...
    _src:{
      harm:          {ref:null, conf:"estimated", note:"Fentanyl not in Nutt 2010. Estimated at 60 based on: heroin=55 in Nutt, plus narrower safety margin, higher potency, and contaminated supply. This is an editorial estimate, not a measured MCDA score."},
      ...
      margin:        {ref:null, conf:"derived", note:"marginBest 20x in medical settings (well-controlled pharmaceutical dosing). marginWorst 1x from street supply with random dosing."},
  ...
  {id:"tramadol",n:"Tramadol",cat:"opioid",aka:["Ultram","Tramal"],src:"synthetic",
    ...
    addict:3,addictLabel:"Moderately addictive",addictPct:8,addictLife:12,
    addictSource:"Estimated — no epidemiological data for tramadol-specific dependence. Rate extrapolated from weak opioid + SNRI pharmacology.",
    ...
    _src:{
      ...
      margin:        {ref:null, conf:"derived", note:"marginBest 6x from seizure threshold (~400mg vs ~75mg dose). marginWorst 2x with SSRI co-administration."},
  ...
  {id:"kratom",n:"Kratom",cat:"opioid",aka:["Mitragynine","Ketum","Biak"],src:"natural",
    ...
    addict:3,addictLabel:"Moderately addictive",addictPct:8,addictLife:12,
    addictSource:"Estimated — partial opioid agonist pharmacology. No epidemiological data. Clinical case reports of dependence exist but no population-level studies.",
    addictNote:"Lower than full opioid agonists. Daily users develop opioid-like physical dependence with withdrawal symptoms.",
    ...
    _src:{
      ...
      margin:        {ref:null, conf:"editorial", note:"marginBest 5x and marginWorst 2x estimated from clinical reports. Nausea is self-limiting at high doses."},
  ...
  {id:"caffeine",n:"Caffeine",cat:"stimulant",aka:["Coffee","Tea","Energy drinks","Pre-workout"],src:"natural",
    ...
    addictSource:"Estimated from DSM-5 caffeine use disorder criteria prevalence. Not from epidemiological survival analysis — DSM-5 criteria are clinical, not population-based.",
    ...
    _src:{
      ...
      margin:        {ref:"gable2006", conf:"derived", note:"Gable 2006: caffeine safety ratio ~100:1 from beverages. marginBest 50x, marginWorst 5x (pure powder) from clinical toxicology."},
  ...
  {id:"ssri",n:"SSRIs",cat:"depressant",aka:["Prozac","Zoloft","Lexapro","Sertraline"],src:"synthetic",
    ...
    addictSource:"Clinical consensus — SSRIs produce physical dependence (discontinuation syndrome) but not addiction (no reward-seeking behavior).",
  ...
  {id:"maoi",n:"MAOIs",cat:"depressant",aka:["Nardil","Parnate","Harmaline","Syrian Rue"],src:"both",
    ...
    addictSource:"Clinical consensus — no addiction potential.",
