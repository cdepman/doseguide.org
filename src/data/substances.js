...
export const S = [
  ...
  {id:"mushrooms",n:"Psilocybin Mushrooms",sn:"Mushrooms",cat:"psychedelic",aka:["Shrooms","Magic Mushrooms","Caps"],src:"natural",
    ...
    chem:{family:"Tryptamine",scaffold:"4-substituted tryptamine",relatives:["dmt","lsd"],bridge:null,note:"4-phosphoryloxy-DMT — literally DMT with a phosphate group at position 4. The body removes the phosphate (via alkaline phosphatase) to produce psilocin, which is 4-hydroxy-DMT."},
  ...
  {id:"mescaline",n:"Mescaline",cat:"psychedelic",aka:["Peyote","San Pedro", "Wachuma"],src:"natural",
    ...
    chem:{family:"Phenethylamine",scaffold:"3,4,5-trimethoxyphenethylamine",relatives:["2cx","mdma"],bridge:null,note:"The simplest psychedelic phenethylamine — just a phenethylamine backbone with three methoxy groups on the ring. 2C-B is its synthetic cousin with different ring substitutions."},
    atDose:1,atDoseLabel:"Safe",
  ...
  {id:"2cx",n:"2C-x (2C-B, 2C-E, 2C-I)",sn:"2C-x",cat:"psychedelic",aka:["Nexus","Bees","Tusi","Pink cocaine"],src:"synthetic",
    ...
    chem:{family:"Phenethylamine",scaffold:"4-bromo-2,5-dimethoxyphenethylamine",relatives:["mescaline","mdma"],bridge:null,note:"Same phenethylamine backbone as mescaline, with bromine and two methoxy groups instead of three. Designed by Alexander Shulgin as a systematic exploration of mescaline's structure-activity relationships."},
  ...
  {id:"cocaine",n:"Cocaine",cat:"stimulant",aka:["Coke","Snow","Blow","Crack"],src:"natural",
    ...
    chem:{family:"Tropane alkaloid",scaffold:"Benzoylmethylecgonine",relatives:[],bridge:{to:"Grouped with stimulants",reason:"Pharmacologically similar to amphetamines (blocks monoamine reuptake) but structurally unrelated — a tropane alkaloid from coca leaves, not a phenethylamine. Blocks transporters rather than reversing them, which changes the addiction and toxicity profile"},note:"The only stimulant on this site that isn't a phenethylamine. Its tropane scaffold is shared with atropine and scopolamine (from nightshade plants), not with amphetamines."},
  ...
  {id:"amphetamines",n:"Amphetamine",sn:"Amfeta",cat:"stimulant",aka:["Speed","Adderall","Dexedrine","Vyvanse"],src:"synthetic",
    ...
    chem:{family:"Phenethylamine",scaffold:"Alpha-methylphenethylamine",relatives:["methamphetamine","mdma"],bridge:null,note:"The simplest substituted phenethylamine stimulant — just a methyl group on the alpha carbon. This single addition makes it orally active and resistant to MAO breakdown. MDMA and meth are both built on this scaffold."},
  ...
  {id:"methamphetamine",n:"Methamphetamine",sn:"Meth",cat:"stimulant",aka:["Meth","Crystal","Ice","Tina","Glass"],src:"synthetic",
    ...
    chem:{family:"Phenethylamine",scaffold:"N-methyl-amphetamine",relatives:["amphetamines","mdma"],bridge:null,note:"Amphetamine with one extra methyl group on the nitrogen. This small change dramatically increases blood-brain barrier penetration (more lipophilic), potency, and dopaminergic neurotoxicity."},
  ...
  {id:"nicotine",n:"Nicotine",cat:"stimulant",aka:["Cigarettes","Vape","Tobacco","Snus","Juul","Zyn"],src:"natural",
    ...
    chem:{family:"Pyridine/pyrrolidine alkaloid",scaffold:"3-(1-methylpyrrolidin-2-yl)pyridine",relatives:[],bridge:null,note:"Unique scaffold found in tobacco and nightshade plants. Acts on nicotinic acetylcholine receptors — a receptor system no other common recreational drug touches."},
  ...
  {id:"cannabis",n:"Cannabis",cat:"cannabinoid",aka:["Marijuana","Weed","THC","Pot","Edibles"],src:"natural",
    ...
    chem:{family:"Cannabinoid",scaffold:"Terpenophenolic (dibenzopyran)",relatives:[],bridge:null,note:"A completely unique chemical class — a phenol ring fused to a terpene-derived ring system. Found only in Cannabis. Acts on CB1/CB2 endocannabinoid receptors, a system no other recreational drug primarily targets."},
    atDose:1,atDoseLabel:"Very safe",
    dangerRank:99,marginBest:null,marginWorst:null,marginLabel:"No known physical danger at any dose",
  ...
  {id:"ketamine",n:"Ketamine",cat:"dissociative",aka:["K","Special K","Ket","Vitamin K"],src:"synthetic",
    ...
    chem:{family:"Arylcyclohexylamine",scaffold:"2-(2-chlorophenyl)-2-(methylamino)cyclohexanone",relatives:["pcp"],bridge:null,note:"Shares the arylcyclohexylamine core with PCP — a cyclohexane ring bonded to an aromatic ring. Developed specifically as a safer, shorter-acting PCP alternative. Both block NMDA glutamate receptors."},
  ...
  {id:"nitrous",n:"Nitrous Oxide",sn:"Nitrous",cat:"dissociative",aka:["Laughing Gas","N2O","Whippets","Nangs"],src:"synthetic",
    ...
    chem:{family:"Inorganic gas",scaffold:"N₂O",relatives:[],bridge:{to:"Acts on opioid + GABA systems",reason:"Just two nitrogen atoms and one oxygen — no carbon at all. Despite having no structural relationship to any drug family, it acts on GABA-A receptors (at the benzodiazepine binding site) AND triggers endogenous opioid peptide release in the brainstem"},note:"The simplest molecule on this site and the most pharmacologically promiscuous. An inorganic gas that somehow hits opioid, GABA, and NMDA systems simultaneously."},
    atDose:1,atDoseLabel:"Very safe",
  ...
  {id:"poppers",n:"Poppers (Alkyl Nitrites)",sn:"Poppers",cat:"inhalant",aka:["Amyl Nitrite","Rush","Jungle Juice","Room Odorizer"],src:"synthetic",
    ...
    chem:{family:"Alkyl nitrite",scaffold:"Isobutyl/amyl/butyl nitrite (R-ONO)",relatives:[],bridge:null,note:"Simple organic nitrites that release nitric oxide, causing vasodilation. No pharmacological relationship to any other substance class — they act on the cardiovascular system via smooth muscle relaxation, not on neurotransmitter receptors in the brain."},
  ...
  {id:"alcohol",n:"Alcohol",cat:"depressant",aka:["Ethanol","Booze","Beer","Wine","Liquor"],src:"natural",
    ...
    chem:{family:"Simple alcohol",scaffold:"Ethanol (C₂H₅OH)",relatives:[],bridge:null,note:"The simplest psychoactive molecule — two carbons, one oxygen, six hydrogens. No structural relationship to any other drug family. Acts on GABA-A and NMDA receptors through direct membrane effects rather than specific receptor binding."},
  ...
  {id:"benzodiazepine",n:"Benzodiazepines",sn:"Benzos",cat:"benzodiazepine",aka:["Benzos","Xanax","Valium","Klonopin","Ativan"],src:"synthetic",
    ...
    chem:{family:"Benzodiazepine",scaffold:"Fused benzene + diazepine ring",relatives:[],bridge:null,note:"Modulate GABA-A receptors at the benzodiazepine binding site — a different spot on the receptor than where alcohol and barbiturates act. This is why a benzodiazepine overdose alone is rarely fatal (ceiling effect), but adding alcohol or opioids removes that ceiling."},
  ...
  {id:"opioids",n:"Opioids (Heroin)",sn:"Opioids",cat:"opioid",aka:["Heroin","Morphine","H","Smack","Dope","Codeine"],src:"both",
    ...
    chem:{family:"Morphinan",scaffold:"Diacetylmorphine (pentacyclic morphinan)",relatives:["fentanyl","tramadol","dxm","kratom"],bridge:null,note:"The classic morphinan scaffold — five fused rings derived from the opium poppy. Heroin is morphine with two acetyl groups that help it cross the blood-brain barrier faster. DXM shares this exact skeleton but acts completely differently."},
  ...
  {id:"fentanyl",n:"Fentanyl",cat:"opioid",aka:["Fent","Blues","Pressed pills","China White"],src:"synthetic",
    ...
    chem:{family:"Synthetic piperidine opioid",scaffold:"4-anilidopiperidine",relatives:["opioids","tramadol"],bridge:null,note:"A completely different chemical scaffold from morphinans — a simple piperidine ring with an anilide group. Designed for maximum mu-opioid potency in a small, easily synthesized molecule. No structural resemblance to heroin despite identical receptor target."},
  ...
  {id:"tramadol",n:"Tramadol",cat:"opioid",aka:["Ultram","Tramal"],src:"synthetic",
    ...
    chem:{family:"Cyclohexanol derivative",scaffold:"trans-2-(dimethylaminomethyl)-1-(3-methoxyphenyl)cyclohexanol",relatives:["opioids","fentanyl"],bridge:{to:"Also an SNRI",reason:"A third distinct opioid scaffold (not a morphinan, not a piperidine). Also inhibits serotonin and norepinephrine reuptake — a dual mechanism that creates interaction risks pure opioids don't have"},note:"Three opioid families, three completely different molecular shapes, one shared receptor target. Tramadol's SNRI activity is why it causes serotonin syndrome with other serotonergic drugs — a risk heroin and fentanyl don't carry."},
  ...
  {id:"kratom",n:"Kratom",cat:"opioid",aka:["Mitragynine","Ketum","Biak"],src:"natural",
    ...
    chem:{family:"Indole alkaloid",scaffold:"Corynanthe-type indole (mitragynine)",relatives:["opioids","dmt","mushrooms"],bridge:{to:"Opioid effects from tryptamine scaffold",reason:"Structurally an indole alkaloid — the same core ring system as tryptamines (DMT, psilocybin). But mitragynine and 7-hydroxymitragynine are partial mu-opioid agonists, not serotonergic psychedelics. A tryptamine-shaped molecule that acts like an opioid"},note:"The most chemically surprising substance on this site. Look at the structure and you'd predict a psychedelic. Take it and you get opioid-like effects. Nature found a way to hit opioid receptors from a completely different chemical starting point."},
  ...
  {id:"caffeine",n:"Caffeine",cat:"stimulant",aka:["Coffee","Tea","Energy drinks","Pre-workout"],src:"natural",
    ...
    chem:{family:"Xanthine",scaffold:"1,3,7-trimethylxanthine (purine derivative)",relatives:[],bridge:null,note:"A purine derivative related to adenosine (which it blocks) and to theobromine in chocolate. No structural relationship to any stimulant or psychedelic family — it works through an entirely different mechanism (adenosine antagonism) than amphetamines (monoamine release)."},
