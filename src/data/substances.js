...
export const S = [
  ...
  {id:"fentanyl",n:"Fentanyl",cat:"opioid",aka:["Fent","Blues","Pressed pills","China White"],src:"synthetic",
    ...
    lethal:{headline:"2 milligrams will kill you. That's a few grains of salt. You can't even see it.",note:"ALWAYS test with fentanyl strips. ALWAYS carry Narcan. If someone stops breathing: CALL 911 and give Narcan IMMEDIATELY.",cmp:"grain",sz:6,realworld:"This dot is roughly the size of a lethal dose. It would disappear on your fingertip. You cannot see it, taste it, or smell it in a pressed pill or powder.",gable:{ed:"25–50 µg",ld:"~2 mg",ratio:"~1:1",note:"Medical ratio ~40:1, but street supply has random dosing — effective ratio is ~1:1"}},
    _src:{
