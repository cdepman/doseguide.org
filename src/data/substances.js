...
export const CITE = {
  ...
  palamar2024:    "Palamar & Krotulski. Medetomidine infiltrates the US illicit opioid market. JAMA 332(17):1425-1426, 2024.",
...
export const S = [
  ...
  {id:"mdma",n:"MDMA",cat:"empathogen",aka:["Ecstasy","Molly","E","X","Mandy"],src:"synthetic",
    ...
    supplyExplain:"26% contains something else: meth, cathinones, caffeine, or nothing. Pressed pills are higher risk than crystal. Reagent testing identifies what's present; fentanyl test strips can detect contamination but cannot measure potency.",
  ...
  {id:"cocaine",n:"Cocaine",cat:"stimulant",aka:["Coke","Snow","Blow","Crack"],src:"natural",
    ...
    supplyExplain:"Average purity now ~88% (DEA 2024), highest in a decade. Levamisole has dropped from 87% (2017) to ~5% (DEA 2024). Fentanyl contamination 2.7% nationally, >10% in NE states (Lim et al. 2024). Fentanyl test strips can detect contamination but cannot measure potency.",
  ...
  {id:"amphetamines",n:"Amphetamine",sn:"Amfeta",cat:"stimulant",aka:["Speed","Adderall","Dexedrine","Vyvanse"],src:"synthetic",
    ...
    supplyExplain:"Pharmacy Adderall: 100% safe. Street speed or pressed pills: may contain meth or fentanyl. Counterfeit Adderall increasing. Any pressed pill can contain fentanyl — test strips detect presence but not quantity.",
  ...
  {id:"ketamine",n:"Ketamine",cat:"dissociative",aka:["K","Special K","Ket","Vitamin K"],src:"synthetic",
    ...
    supplyExplain:"Sometimes cut with MSG, creatine, or fillers. Occasionally substituted entirely. Fentanyl contamination of ketamine has been reported in some markets. Reagent kits and fentanyl test strips can identify what's present.",
  ...
  {id:"benzodiazepine",n:"Benzodiazepines",sn:"Benzos",cat:"benzodiazepine",aka:["Benzos","Xanax","Valium","Klonopin","Ativan"],src:"synthetic",
    ...
    supplyExplain:"Pharmacy benzos: 100% safe. Street 'Xanax bars': frequently contain fentanyl or novel benzos (bromazolam rose from 4% to 73% of novel benzos by 2023). Pressed pills have wildly unpredictable dosing — bromazolam content ranges from 0.09 mg to 5.4 mg in tested samples, a 60x variance. Any pressed pill can contain fentanyl. Test strips detect presence but not quantity.",
  ...
  {id:"opioids",n:"Opioids (Heroin)",sn:"Opioids",cat:"opioid",aka:["Heroin","Morphine","H","Smack","Dope","Codeine"],src:"both",
    ...
    supplyExplain:"The US heroin supply has been almost entirely replaced by illicitly manufactured fentanyl. Only ~2% of samples test as expected heroin (Maryland RAD data). Xylazine and medetomidine (veterinary sedatives) are now common adulterants that deepen respiratory depression through non-opioid pathways and are not reversed by naloxone. Fentanyl test strips are essentially irrelevant here — the supply IS fentanyl. Assume every dose contains it.",
  ...
  {id:"fentanyl",n:"Fentanyl",cat:"opioid",aka:["Fent","Blues","Pressed pills","China White"],src:"synthetic",
    ...
    supplyExplain:"Street fentanyl now routinely contains adulterants that change its danger profile. Xylazine ('tranq') is a veterinary sedative found in up to 95% of fentanyl samples in some eastern US cities. Xylazine deepens respiratory depression through a separate mechanism (alpha-2 adrenergic, not opioid) — naloxone/Narcan only partially reverses an overdose. Medetomidine, 100-300x more potent than xylazine, is replacing it in some markets — found in 87% of Philadelphia fentanyl samples by late 2024. Neither is reversed by naloxone.",
    ...
    lethal:{headline:"2 milligrams will kill you. That's a few grains of salt. You can't even see it.",note:"The difference between an active dose and a fatal dose is measured in micrograms — invisible to the eye. Street fentanyl varies wildly in potency. There is no way to dose safely without pharmaceutical-grade measurement. Narcan reverses opioid overdose — if someone stops breathing, call 911 and give Narcan immediately.",cmp:"grain",sz:6,realworld:"This dot is roughly the size of a lethal dose. It would disappear on your fingertip. You cannot see it, taste it, or smell it in a pressed pill or powder.",gable:{ed:"25–50 µg",ld:"~2 mg",ratio:"~1:1",note:"Medical ratio ~40:1, but street supply has random dosing — effective ratio is ~1:1"}},
    _src:{
      ...
      supply:        {ref:["kariisa2023","palamar2024"],conf:"measured",note:"Xylazine prevalence from CDC MMWR 2023. Medetomidine data from Palamar & Krotulski 2024 (JAMA) and Huo & Perrone 2025."},
    }},
  ...
  {id:"methadone_rx",n:"Methadone / Buprenorphine (MOUD)",sn:"MOUD",cat:"medication",
    aka:["Methadone","Suboxone","Buprenorphine","Subutex","MOUD","MAT","OAT","Dolophine"],src:"synthetic",
    desc:"Medication for opioid use disorder (MOUD). Prescribed for opioid dependence treatment. Combining with other opioids, benzos, alcohol, or sedatives is extremely dangerous. Methadone also prolongs QT interval, adding cardiac risk with stimulants.",
    isMedication:true,
    atDose:null,atDoseLabel:null,dangerRank:null,
    marginBest:null,marginWorst:null,marginLabel:null,
