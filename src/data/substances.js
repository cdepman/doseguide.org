...
export const S = [
  {id:"lsd",n:"LSD",cat:"psychedelic",aka:["Acid","Lucy","Tabs","Blotter"],src:"semi-synthetic",
    ...
    supplyRisk:2,pctAsExpected:98,supplyLabel:"~98% is real LSD",supplyExplain:"NBOMe compounds (dangerous!) occasionally sold as LSD. An Ehrlich reagent test turns purple for real LSD — NBOMe does not react.",
  ...
  {id:"2cx",n:"2C-x (2C-B, 2C-E, 2C-I)",sn:"2C-x",cat:"psychedelic",aka:["Nexus","Bees","Tusi","Pink cocaine"],src:"synthetic",
    ...
    atDose:2,atDoseLabel:"Safe if dosed carefully",dangerRank:10,marginBest:4,marginWorst:2,marginLabel:"Some room, but effects jump sharply with small increases",marginExplain:"2C-B is not particularly toxic at recreational doses, but the dose-response curve is unusually steep. The difference between 15mg and 30mg is not 'twice as strong' — it's a qualitatively different experience. Vasoconstriction becomes concerning above 40-50mg. The difference between a strong and dangerous dose can be 5mg — a milligram scale is the only way to measure accurately.",
    supplyRisk:4,pctAsExpected:50,supplyLabel:"~50% — 'Tusi/pink cocaine' is almost never 2C-B",supplyExplain:"'Tusi' frequently contains ketamine, MDMA, caffeine, or no 2C-B at all. Actual 2C-B is typically white. Reagent testing can identify what's actually present.",
  ...
  {id:"mdma",n:"MDMA",cat:"empathogen",aka:["Ecstasy","Molly","E","X","Mandy"],src:"synthetic",
    ...
    supplyRisk:4,pctAsExpected:74,supplyLabel:"~74% contains only MDMA",supplyExplain:"26% contains something else: meth, cathinones, caffeine, or nothing. Pressed pills are higher risk than crystal. Reagent testing and fentanyl strips can identify what's actually in the sample.",
  ...
  {id:"cocaine",n:"Cocaine",cat:"stimulant",aka:["Coke","Snow","Blow","Crack"],src:"natural",
    ...
    supplyRisk:5,pctAsExpected:81,supplyLabel:"~81% contains cocaine, but often with adulterants",supplyExplain:"Most contains cocaine but also levamisole (~70% of US supply). Fentanyl contamination >10% in NE states. Fentanyl strips can detect contamination.",
  ...
  {id:"cannabis",n:"Cannabis",cat:"cannabinoid",aka:["Marijuana","Weed","THC","Pot","Edibles"],src:"natural",
    ...
    atDose:1,atDoseLabel:"Very safe",dangerRank:99,marginBest:null,marginWorst:null,marginLabel:"No known physical danger at any dose",marginExplain:"No human has ever died from cannabis toxicity. The ratio is over 1,000:1. Edibles can cause extreme anxiety and psychological distress that feels like an emergency — but the body is completely fine. The experience ends on its own.",
  ...
  {id:"dxm",n:"DXM",cat:"dissociative",aka:["Dextromethorphan","Robo","Robotripping"],src:"synthetic",
    ...
    supplyRisk:3,pctAsExpected:95,supplyLabel:"~95% — but CHECK THE OTHER INGREDIENTS",supplyExplain:"DXM itself is what it says. The danger is OTHER active ingredients in the product — acetaminophen causes liver failure at recreational DXM doses. DXM-only products are the only ones without this risk.",
  ...
  {id:"nitrous",n:"Nitrous Oxide",sn:"Nitrous",cat:"dissociative",aka:["Laughing Gas","N2O","Whippets","Nangs"],src:"synthetic",
    ...
    atDose:1,atDoseLabel:"Very safe",dangerRank:17,marginBest:null,marginWorst:null,marginLabel:"Danger is the delivery method, not the amount",marginExplain:"Each individual balloon is self-limiting. The gas has an enormous safety margin per use. Deaths are from: suffocation (bags or masks trap the gas and cut off oxygen — balloons do not), falls while standing, and chronic B12 depletion from daily heavy use over weeks or months causing nerve damage.",
  ...
  {id:"poppers",n:"Poppers (Alkyl Nitrites)",sn:"Poppers",cat:"inhalant",aka:["Amyl Nitrite","Rush","Jungle Juice","Room Odorizer"],src:"synthetic",
    ...
    atDose:2,atDoseLabel:"Safe at normal use",dangerRank:18,marginBest:null,marginWorst:null,marginLabel:"Danger is swallowing or drug interactions, not inhaling",marginExplain:"Inhaling poppers has a wide margin — the effects are brief and self-limiting. The dangers: swallowing the liquid causes methemoglobinemia (a medical emergency), combining with Viagra/Cialis/Levitra causes a fatal blood pressure crash, and pre-existing heart conditions increase risk.",
  ...
  {id:"ghb",n:"GHB",cat:"depressant",aka:["G","Liquid Ecstasy","GBL","1,4-BD","Fantasy"],src:"synthetic",
    ...
    supplyRisk:2,pctAsExpected:85,supplyLabel:"~85% — liquid is hard to adulterate",supplyExplain:"GHB liquid is hard to cut. Main danger: confusion between GHB, GBL, and 1,4-BD — GBL is ~2x as potent. A syringe is the only reliable way to measure doses this small.",
    addict:4,addictLabel:"Highly addictive",addictPct:12,addictLife:15,addictEstimated:true,addictSource:"Estimated from European clinical case series",addictNote:"Physical dependence develops with daily use. GHB withdrawal is among the most dangerous — it can cause seizures, psychosis, and death. Abrupt cessation after daily use is life-threatening.",
