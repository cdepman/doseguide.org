...
export const CITE = {
  ...
  dea_cocaine2024:"DEA CY2024 Annual Cocaine Report (PRB# 2025-42). Average purity 88%, levamisole ~5%.",
  broman2025:     "Broman M, Davis AK, Armstrong S, et al. US drug policy does not align with experts' rankings of drug harms. Harm Reduction Journal 23(1):17, 2025.",
  ferreira2022:   "Ferreira PM, Winstock AR, Schlag AK, et al. Drug harms: an international Delphi study. Drug Science, Policy and Law 8, 2022.",
  stone2007:      "Stone AL, O'Brien MS, De La Torre A, Anthony JC. Who is becoming hallucinogen dependent soon after hallucinogen use starts? Drug Alcohol Depend 87(2-3):153-163, 2007.",
  blanco2018:     "Blanco C, Han B, Jones CM, Johnson K, Compton WM. Prevalence and correlates of benzodiazepine use, misuse, and use disorders. J Clin Psychiatry 79(6):18m12174, 2018.",
  mittleman1999:  "Mittleman MA, et al. Triggering of myocardial infarction by cocaine. Circulation 99(21):2737-2741, 1999.",
  ...
  gable2004:      "Gable RS. Comparison of acute lethal toxicity of commonly abused psychoactive substances. Addiction 99(6):686-696, 2004.",
  barrios2025:    "Barrios KP, et al. Ketamine use in a large global sample. J Psychopharmacol 39(1), 2025. GDS 2018 n=130,761.",
  han2021:        "Han B, et al. Methamphetamine use, methamphetamine use disorder, and associated overdose deaths. JAMA Psychiatry 78(12):1329-1342, 2021.",
  dijkstra2021:   "Dijkstra BA, et al. GHB use disorder: a systematic review. Int J Drug Policy 94:103230, 2021.",
  lim2024:        "Lim TY, et al. Fentanyl co-occurrence in stimulant samples. Lancet Regional Health Americas, 2024. 11.9M NFLIS samples.",
  jones2015:      "Jones CM, McAninch JK. ED visits and overdose deaths from combined opioid-benzodiazepine use. Am J Prev Med 49(4):493-501, 2015.",
};
...
export const S = [
  ...
  {id:"lsd",n:"LSD",cat:"psychedelic",aka:["Acid","Lucy","Tabs","Blotter"],src:"semi-synthetic",
    ...
    addict:1,addictLabel:"Not addictive",addictPct:3,addictLife:4.9,
    addictSource:"Stone et al. 2007 (NHSDA): 2-3% within 24 months of first use. Anthony 1994: ~4.9% lifetime for 'hallucinogens' (includes PCP/MDMA, not LSD-specific).",
    addictNote:"Rapid tolerance makes daily use impossible — you literally can't trip two days in a row. No physical dependence. Among the lowest addiction potential of any psychoactive substance. Note: 'hallucinogen' category in epidemiological studies includes PCP and sometimes MDMA, so the true LSD-specific rate is likely lower.",
    ...
    _src:{
      ...
      addictPct:     {ref:"anthony1994", conf:"derived", note:"Stone et al. 2007 (NHSDA n=114,241): 2-3% within 24 months. Anthony 1994: ~4.9% lifetime for 'hallucinogens' (includes PCP, possibly MDMA). Using 3% as best incidence-window estimate. Not LSD-specific."},
  ...
  {id:"mushrooms",n:"Psilocybin Mushrooms",sn:"Mushrooms",cat:"psychedelic",aka:["Shrooms","Magic Mushrooms","Caps"],src:"natural",
    ...
    addict:1,addictLabel:"Not addictive",addictPct:3,addictLife:4.9,
    addictSource:"Same hallucinogen category as LSD: Stone et al. 2007, Anthony 1994. Not psilocybin-specific.",
    addictNote:"Same rapid tolerance mechanism as LSD. The experience itself discourages frequent use for most people. Rate reflects broad 'hallucinogen' category — true psilocybin-specific rate is likely lower.",
  ...
  {id:"dmt",n:"DMT",cat:"psychedelic",aka:["Dimitri","Spirit Molecule","Ayahuasca"],src:"natural",
    ...
    addict:1,addictLabel:"Not addictive",addictPct:3,addictLife:4.9,
    addictSource:"Broad 'hallucinogen' category (Stone 2007, Anthony 1994). No DMT-specific data. Self-limiting pharmacology suggests lower rate.",
    addictNote:"Intensity and brevity naturally limit use frequency. Rate reflects broad hallucinogen category — DMT-specific rate is likely lower given self-limiting pharmacology.",
  ...
  {id:"mescaline",n:"Mescaline",cat:"psychedelic",aka:["Peyote","San Pedro"],src:"natural",
    ...
    addict:1,addictLabel:"Not addictive",addictPct:3,addictLife:4.9,
    addictSource:"Broad 'hallucinogen' category (Stone 2007, Anthony 1994). No mescaline-specific data.",
    addictNote:"Long duration (8-12hr) and severe nausea further discourage frequent use. Rate reflects broad hallucinogen category.",
  ...
  {id:"2cx",n:"2C-x (2C-B, 2C-E, 2C-I)",sn:"2C-x",cat:"psychedelic",aka:["Nexus","Bees","Tusi","Pink cocaine"],src:"synthetic",
    ...
    addict:1,addictLabel:"Not addictive",addictPct:3,addictLife:4.9,
    addictSource:"Broad 'hallucinogen' category (Stone 2007, Anthony 1994). No 2C-x-specific data.",
  ...
  {id:"cocaine",n:"Cocaine",cat:"stimulant",aka:["Coke","Snow","Blow","Crack"],src:"natural",
    ...
    marginExplain:"Most people tolerate a few lines (100-300mg total) without incident. The honest risk: cocaine increases MI risk 23.7-fold in the 60 minutes after use (Mittleman 1999). The risk rises steeply with dose, re-dosing over hours, combining with alcohol (creates cocaethylene), and any pre-existing heart condition — even undiagnosed ones.",
    ...
    _src:{
      ...
      margin:        {ref:null, conf:"editorial", note:"marginBest 5x and marginWorst 1x are clinical estimates. Mittleman 1999: 23.7-fold MI risk increase within 60 min of use. The previously cited '1 in 50,000' figure cannot be verified in peer-reviewed literature."},
  ...
  {id:"methamphetamine",n:"Methamphetamine",sn:"Meth",cat:"stimulant",aka:["Meth","Crystal","Ice","Tina","Glass"],src:"synthetic",
    ...
    addict:5,addictLabel:"Extremely addictive",addictPct:11.2,addictLife:20,
    addictSource:"Anthony 1994 grouped under 'stimulants' at ~11.2%. No meth-specific capture rate exists. Han et al. 2021 (NSDUH 2015-2019) found ~52% of past-year users had MUD, but this is current-user proportion, not first-use transition probability.",
    addictNote:"Higher than regular amphetamine due to extreme dopamine release and long duration. Binge patterns develop quickly. The 11.2% reflects all stimulants (Anthony 1994) — meth-specific rate is likely higher but unmeasured.",
  ...
  {id:"ketamine",n:"Ketamine",cat:"dissociative",aka:["K","Special K","Ket","Vitamin K"],src:"synthetic",
    ...
    addictSource:"Barrios et al. 2025 (GDS 2018, n=130,761): 8.55% of past-year users met dependence criteria. Online convenience sample, not population-based.",
  ...
  {id:"dxm",n:"DXM",cat:"dissociative",aka:["Dextromethorphan","Robo","Robotripping"],src:"synthetic",
    ...
    _src:{
      ...
      margin:        {ref:"gable2004", conf:"measured", note:"Gable 2004: DXM safety ratio = 10 (effective 150mg, lethal 1.5g). marginBest 5x for pure DXM. marginWorst 1x reflects acetaminophen co-formulation and CYP2D6 poor metabolizer risk (5-10% Caucasian, Bradford 2002)."},
  ...
  {id:"ghb",n:"GHB",cat:"depressant",aka:["G","Liquid Ecstasy","GBL","1,4-BD","Fantasy"],src:"synthetic",
    ...
    addictSource:"Estimated — no dependence capture rate has been published for GHB (Dijkstra et al. 2021). Population prevalence too low (~0.05%) for transition probability estimation. Expert assessment: 2.55/4.0 dependence potential (van Amsterdam et al. 2012). 12% is an editorial estimate.",
    addictNote:"Physical dependence develops with daily use. GHB withdrawal is among the most dangerous — it can cause seizures, psychosis, and death. Abrupt cessation after daily use is life-threatening. No population-based capture rate exists.",
    ...
    _src:{
      ...
      margin:        {ref:"gable2004", conf:"measured", note:"Gable 2004: GHB safety ratio = 8 (effective 1.4-3g, lethal 16g). marginBest 2.5x and marginWorst 1.5x account for alcohol co-ingestion."},
