...
export const S = [
  {id:"lsd",n:"LSD",cat:"psychedelic",aka:["Acid","Lucy","Tabs","Blotter"],src:"semi-synthetic",
    ...
    addict:1,addictLabel:"Not addictive",addictPct:0.5,addictLife:1,addictSource:"Derived from Anthony 1994",addictNote:"Rapid tolerance makes daily use impossible — you literally can't trip two days in a row. No physical dependence. Among the lowest addiction potential of any psychoactive substance.",
    overwhelm:4,overwhelmLabel:"Very easy — especially liquid. A few drops too many = a very different experience",
  ...
  {id:"mushrooms",n:"Psilocybin Mushrooms",cat:"psychedelic",aka:["Shrooms","Magic Mushrooms","Caps"],src:"natural",
    ...
    addict:1,addictLabel:"Not addictive",addictPct:0.5,addictLife:1,addictSource:"Same as LSD — classical psychedelics",addictNote:"Same rapid tolerance mechanism as LSD. The experience itself discourages frequent use for most people.",
    overwhelm:2,overwhelmLabel:"Moderate — whole mushrooms are easy to weigh, but potency varies between batches",
  ...
  {id:"dmt",n:"DMT",cat:"psychedelic",aka:["Dimitri","Spirit Molecule","Ayahuasca"],src:"natural",
    ...
    addict:1,addictLabel:"Not addictive",addictPct:0.5,addictLife:1,addictSource:"Clinical consensus",addictNote:"Intensity and brevity naturally limit use frequency.",
    overwhelm:2,overwhelmLabel:"Moderate — intensity is self-limiting. Very hard to take more once it hits",
  ...
  {id:"mescaline",n:"Mescaline",cat:"psychedelic",aka:["Peyote","San Pedro"],src:"natural",
    ...
    addict:1,addictLabel:"Not addictive",addictPct:0.5,addictLife:1,addictSource:"Derived from Anthony 1994",addictNote:"Long duration (8-12hr) and severe nausea further discourage frequent use.",
    overwhelm:1,overwhelmLabel:"Hard — requires eating a lot of cactus material. Nausea stops you first",
  ...
  {id:"2cx",n:"2C-x (2C-B, 2C-E, 2C-I)",cat:"psychedelic",aka:["Nexus","Bees","Tusi","Pink cocaine"],src:"synthetic",
    ...
    addict:1,addictLabel:"Not addictive",addictPct:0.5,addictLife:1,addictSource:"Clinical consensus — phenethylamine psychedelic",addictNote:"Similar tolerance and self-limiting profile to other psychedelics.",
    overwhelm:4,overwhelmLabel:"Very easy — 5mg more can feel like a completely different drug",
  ...
  {id:"mdma",n:"MDMA",cat:"empathogen",aka:["Ecstasy","Molly","E","X","Mandy"],src:"synthetic",
    ...
    addict:2,addictLabel:"Low addiction potential",addictPct:3,addictLife:5,addictSource:"Estimated from Schlag 2020 review",addictNote:"Low capture rate partly because serotonin depletion makes frequent use self-punishing — you feel worse, not better, if you use too often.",
    overwhelm:3,overwhelmLabel:"Moderate — temptation to re-dose when it 'isn\\'t working yet'",
  ...
  {id:"cocaine",n:"Cocaine",cat:"stimulant",aka:["Coke","Snow","Blow","Crack"],src:"natural",
    ...
    overwhelm:4,overwhelmLabel:"Very easy — short duration drives compulsive re-dosing",
  ...
  {id:"amphetamines",n:"Amphetamine",cat:"stimulant",aka:["Speed","Adderall","Dexedrine","Vyvanse"],src:"synthetic",
    ...
    overwhelm:2,overwhelmLabel:"Moderate — pharmaceutical pills are consistent doses",
  ...
  {id:"methamphetamine",n:"Methamphetamine",cat:"stimulant",aka:["Meth","Crystal","Ice","Tina","Glass"],src:"synthetic",
    ...
    addict:5,addictLabel:"Extremely addictive",addictPct:15,addictLife:20,addictSource:"Estimated from SAMHSA 2016 + clinical literature",addictNote:"Higher than regular amphetamine due to extreme dopamine release and long duration. Binge patterns develop quickly.",
    overwhelm:4,overwhelmLabel:"Very easy — compulsive re-dosing over 24+ hours",
  ...
  {id:"nicotine",n:"Nicotine",cat:"stimulant",aka:["Cigarettes","Vape","Tobacco","Snus","Juul","Zyn"],src:"natural",
    ...
    addict:5,addictLabel:"EXTREMELY addictive",addictPct:15.6,addictLife:67.5,addictSource:"Lopez-Quintero 2011 (NESARC)",addictNote:"The gap between 10yr (16%) and lifetime (68%) tells the story: nicotine hooks you slowly but relentlessly. Hardest substance to quit permanently.",
    overwhelm:1,overwhelmLabel:"Hard — nausea stops you. BUT liquid nicotine is extremely easy to overdose",
  ...
  {id:"cannabis",n:"Cannabis",cat:"cannabinoid",aka:["Marijuana","Weed","THC","Pot","Edibles"],src:"natural",
    ...
    overwhelm:4,overwhelmLabel:"Very easy with edibles — slow onset tricks you into eating more",
  ...
  {id:"ketamine",n:"Ketamine",cat:"dissociative",aka:["K","Special K","Ket","Vitamin K"],src:"synthetic",
    ...
    addict:3,addictLabel:"Moderately addictive",addictPct:6,addictLife:9,addictSource:"Estimated from UK clinical literature",addictNote:"Psychological dependence develops with regular use. The bigger chronic risk is bladder damage — daily users can end up needing their bladder surgically removed.",
    overwhelm:3,overwhelmLabel:"Moderate — dose-response can be steep, especially insufflated",
  ...
  {id:"pcp",n:"PCP",cat:"dissociative",aka:["Angel Dust","Wet","Sherm","Dust"],src:"synthetic",
    ...
    addict:3,addictLabel:"Moderately addictive",addictPct:5,addictLife:7,addictSource:"Estimated from NIDA reports",addictNote:"Psychological dependence can develop. Less studied than other substances because of smaller user population.",
    overwhelm:4,overwhelmLabel:"Very easy — response is unpredictable at any dose",
  ...
  {id:"dxm",n:"DXM",cat:"dissociative",aka:["Dextromethorphan","Robo","Robotripping"],src:"synthetic",
    ...
    addict:2,addictLabel:"Low addiction potential",addictPct:3,addictLife:5,addictSource:"Estimated — limited data",addictNote:"Some users develop compulsive patterns but clinical data is sparse. Primarily psychological.",
    overwhelm:3,overwhelmLabel:"Moderate — plateau system is confusing. Easy to overshoot",
  ...
  {id:"nitrous",n:"Nitrous Oxide",cat:"dissociative",aka:["Laughing Gas","N2O","Whippets","Nangs"],src:"synthetic",
    ...
    overwhelm:1,overwhelmLabel:"Hard — each hit is tiny and brief. Self-limiting",
  ...
  {id:"poppers",n:"Poppers (Alkyl Nitrites)",cat:"inhalant",aka:["Amyl Nitrite","Rush","Jungle Juice","Room Odorizer"],src:"synthetic",
    ...
    overwhelm:1,overwhelmLabel:"Hard — effects are brief and self-limiting",
  ...
  {id:"alcohol",n:"Alcohol",cat:"depressant",aka:["Ethanol","Booze","Beer","Wine","Liquor"],src:"natural",
    ...
    overwhelm:4,overwhelmLabel:"Very easy — being drunk impairs your judgment about drinking more",
  ...
  {id:"ghb",n:"GHB",cat:"depressant",aka:["G","Liquid Ecstasy","GBL","1,4-BD","Fantasy"],src:"synthetic",
    ...
    addict:4,addictLabel:"Highly addictive",addictPct:12,addictLife:15,addictSource:"Estimated from European clinical case series",addictNote:"Physical dependence develops with daily use. GHB withdrawal is among the most dangerous — it can cause seizures, psychosis, and death. Never stop abruptly.",
    overwhelm:5,overwhelmLabel:"Extremely easy — the difference between perfect and unconscious is < half a teaspoon",
  ...
  {id:"benzodiazepine",n:"Benzodiazepines",cat:"benzodiazepine",aka:["Benzos","Xanax","Valium","Klonopin","Ativan"],src:"synthetic",
    ...
    addict:4,addictLabel:"Highly addictive",addictPct:14,addictLife:18,addictSource:"Estimated from Nutt 2007 + clinical literature",addictNote:"Physical dependence can develop in 2-4 weeks of daily use. Prescribed users often don't realize they're dependent until they try to stop. Withdrawal can cause seizures and death.",
    overwhelm:3,overwhelmLabel:"Moderate — amnesia makes you forget you already took some",
  ...
  {id:"opioids",n:"Opioids (Heroin)",cat:"opioid",aka:["Heroin","Morphine","H","Smack","Dope","Codeine"],src:"both",
    ...
    overwhelm:4,overwhelmLabel:"Very easy — street supply potency is unknown",
  ...
  {id:"fentanyl",n:"Fentanyl",cat:"opioid",aka:["Fent","Blues","Pressed pills","China White"],src:"synthetic",
    ...
    addict:5,addictLabel:"EXTREMELY addictive",addictPct:20,addictLife:25,addictSource:"Estimated — same receptor as heroin, faster onset",addictNote:"Same mechanism as heroin but faster onset = stronger reinforcement. Most fentanyl exposure is unintentional. Dependence develops very rapidly.",
    overwhelm:5,overwhelmLabel:"Impossible to dose safely without precision equipment",
  ...
  {id:"tramadol",n:"Tramadol",cat:"opioid",aka:["Ultram","Tramal"],src:"synthetic",
    ...
    addict:3,addictLabel:"Moderately addictive",addictPct:8,addictLife:12,addictSource:"Estimated — weak opioid + SNRI",addictNote:"Lower than strong opioids. Dependence develops with regular use, and withdrawal includes both opioid symptoms and seizure risk.",
    overwhelm:2,overwhelmLabel:"Moderate — pharmaceutical pills are consistent",
  ...
  {id:"kratom",n:"Kratom",cat:"opioid",aka:["Mitragynine","Ketum","Biak"],src:"natural",
    ...
    addict:3,addictLabel:"Moderately addictive",addictPct:8,addictLife:12,addictSource:"Estimated — partial opioid agonist",addictNote:"Lower than full opioid agonists. Daily users develop opioid-like physical dependence with withdrawal symptoms.",
    overwhelm:2,overwhelmLabel:"Moderate — powder is hard to measure precisely but margin is wide",
  ...
  {id:"caffeine",n:"Caffeine",cat:"stimulant",aka:["Coffee","Tea","Energy drinks","Pre-workout"],src:"natural",
    ...
    overwhelm:1,overwhelmLabel:"Hard from drinks — but pure powder is shockingly easy to overdose",
  ...
  {id:"ssri",n:"SSRIs",cat:"depressant",aka:["Prozac","Zoloft","Lexapro","Sertraline"],src:"synthetic",
    ...
    overwhelm:1,overwhelmLabel:"Hard — pharmaceutical pills",
  ...
  {id:"maoi",n:"MAOIs",cat:"depressant",aka:["Nardil","Parnate","Harmaline","Syrian Rue"],src:"both",
    ...
    overwhelm:1,overwhelmLabel:"Hard — pharmaceutical pills, but interaction danger is the real risk",
