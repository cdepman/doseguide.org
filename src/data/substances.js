...
export const S = [
  ...
  {id:"kratom",n:"Kratom",cat:"opioid",aka:["Mitragynine","Ketum","Biak"],src:"natural",
    ...
    addict:3,addictLabel:"Moderately addictive",addictPct:8,addictLife:12,
    addictSource:"Singh et al. 2014 (n=293 regular Malaysian users): >50% severe dependence. Rogers et al. 2024 (n=395 US): 80.7% mild/moderate kratom use disorder. Both among established users. 8% is a conservative population estimate.",
  ...
  {id:"caffeine",n:"Caffeine",cat:"stimulant",aka:["Coffee","Tea","Energy drinks","Pre-workout"],src:"natural",
    ...
    addictSource:"Sweeney et al. 2020 (n=1,006 US adults): 8% met all 3 DSM-5 CUD criteria. Meredith et al. 2013 review: 9-14%.",
